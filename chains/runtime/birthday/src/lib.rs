...
parameter_types! {
	// after looking the https://chainlist.org/, `1988` is a good number since no other public network are using it
	pub const ChainId: u64 = 1988;
